...
namespace SuggestionBox.Controllers
{
    public class SuggestionModelsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "RecordNum,Topic,Comment")] SuggestionModel suggestionModel)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "RecordNum,Topic,Comment")] SuggestionModel suggestionModel)
        {
            if (ModelState.IsValid)
            {
